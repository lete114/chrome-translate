...
.leading-\\[1\\.5\\]{line-height:1.5;};
  ...
  const closeIcon = b`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`;
  const LANGUAGES = [
{ label: "EN", value: "en" },
...
.op-50{opacity:0.5;}
.shadow-\\[0_1px_3px_rgba\\(0\\,0\\,0\\,\\.2\\)\\]{--un-shadow:0 1px 3px var(--un-shadow-color, rgba(0, 0, 0, .2));box-shadow:var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow);}
.transition-all{transition-property:all;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms;}
.transition-colors{transition-property:color,background-color,border-color,text-decoration-color,fill,stroke;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms;}
...
.transition-duration-0\\.3s{transition-duration:0.3s;};
  ...
  __decorateClass$2([
    n2({ type: String })
  ], ChromeTranslateSettings.prototype, "displayMode", 2);
  __decorateClass$2([
    n2({ type: Number })
  ], ChromeTranslateSettings.prototype, "batchSize", 2);
  __decorateClass$2([
    n2({ type: Boolean })
  ], ChromeTranslateSettings.prototype, "selectionTranslate", 2);
  __decorateClass$2([
    n2({ type: String })
  ...
  let ChromeTranslateBall = class extends i {
    ...
    async initTranslate() {
      ...
      t2.instance.mode = this.displayMode;
    ...
    async resetToDefault() {
      ...
      if (t2) {
        ...
        t2.instance.mode = DEFAULT_CONFIG.displayMode;
...
.ease{transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);};
  ...
  __decorateClass$1([
    r()
  ], ChromeTranslateBall.prototype, "displayMode", 2);
  __decorateClass$1([
    r()
  ], ChromeTranslateBall.prototype, "batchSize", 2);
  __decorateClass$1([
    r()
  ], ChromeTranslateBall.prototype, "selectionTranslate", 2);
  __decorateClass$1([
    r()
  ...
  let ChromeTranslateSelection = class extends i {
    constructor() {
      ...
      this.onKeyDown = (e2) => {
        if (e2.key === "Escape" && this.phase !== "hidden") {
          clearTimeout(this.showButtonTimer);
          this.phase = "hidden";
        }
      };
    ...
    async onTranslate(e2) {
      ...
      try {
        ...
        let openaiProvider = this.translator.getProvider("openai");
        if (!openaiProvider) {
  ...
  ChromeTranslateSelection.styles = i$3`
    :host {
      all: initial;
...
*,::before,::after{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgb(0 0 0 / 0);--un-ring-shadow:0 0 rgb(0 0 0 / 0);--un-shadow-inset: ;--un-shadow:0 0 rgb(0 0 0 / 0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgb(147 197 253 / 0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}::backdrop{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgb(0 0 0 / 0);--un-ring-shadow:0 0 rgb(0 0 0 / 0);--un-shadow-inset: ;--un-shadow:0 0 rgb(0 0 0 / 0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgb(147 197 253 / 0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}
/* layer: default */
.hover\\:\\[--sel-btn-y\\:calc\\(-50\\%_-_2px\\)\\]:hover{--sel-btn-y:calc(-50% - 2px);}
.active\\:\\[--sel-btn-y\\:calc\\(-50\\%_\\+_1px\\)\\]:active{--sel-btn-y:calc(-50% + 1px);}
.fixed{position:fixed;}
.static{position:static;}
...
.flex-col{flex-direction:column;}
.transform{transform:translateX(var(--un-translate-x)) translateY(var(--un-translate-y)) translateZ(var(--un-translate-z)) rotate(var(--un-rotate)) rotateX(var(--un-rotate-x)) rotateY(var(--un-rotate-y)) rotateZ(var(--un-rotate-z)) skewX(var(--un-skew-x)) skewY(var(--un-skew-y)) scaleX(var(--un-scale-x)) scaleY(var(--un-scale-y)) scaleZ(var(--un-scale-z));}
.animate-\\[ct-spin_0\\.6s_linear_infinite\\]{animation:ct-spin 0.6s linear infinite;}
.cursor-pointer{cursor:pointer;}
.resize{resize:both;}
.items-center{align-items:center;}
.justify-end{justify-content:flex-end;}
...
.border-t-\\[\\#00c4b6\\]{--un-border-opacity:1;--un-border-top-opacity:var(--un-border-opacity);border-top-color:rgb(0 196 182 / var(--un-border-top-opacity));}
...
.bg-\\[\\#f0f0f0\\]{--un-bg-opacity:1;background-color:rgb(240 240 240 / var(--un-bg-opacity)) /* #f0f0f0 */;}
.bg-white{--un-bg-opacity:1;background-color:rgb(255 255 255 / var(--un-bg-opacity)) /* #fff */;}
.hover\\:bg-\\[\\#00a89a\\]:hover{--un-bg-opacity:1;background-color:rgb(0 168 154 / var(--un-bg-opacity)) /* #00a89a */;}
.hover\\:bg-\\[\\#e0e0e0\\]:hover{--un-bg-opacity:1;background-color:rgb(224 224 224 / var(--un-bg-opacity)) /* #e0e0e0 */;}
.p-\\[14px_16px\\]{padding:14px 16px;}
.p-0{padding:0;}
.px{padding-left:1rem;padding-right:1rem;}
...
.text-\\[\\#222\\]{--un-text-opacity:1;color:rgb(34 34 34 / var(--un-text-opacity)) /* #222 */;}
.text-\\[\\#333\\]{--un-text-opacity:1;color:rgb(51 51 51 / var(--un-text-opacity)) /* #333 */;}
.text-\\[\\#888\\]{--un-text-opacity:1;color:rgb(136 136 136 / var(--un-text-opacity)) /* #888 */;}
.text-\\[\\#e74c3c\\]{--un-text-opacity:1;color:rgb(231 76 60 / var(--un-text-opacity)) /* #e74c3c */;}
.text-white{--un-text-opacity:1;color:rgb(255 255 255 / var(--un-text-opacity)) /* #fff */;}
.hover\\:text-\\[\\#555\\]:hover{--un-text-opacity:1;color:rgb(85 85 85 / var(--un-text-opacity)) /* #555 */;}
.font-medium{font-weight:500;}
.leading-\\[1\\.5\\]{line-height:1.5;}
.shadow-\\[0_4px_24px_rgba\\(0\\,0\\,0\\,\\.2\\)\\]{--un-shadow:0 4px 24px var(--un-shadow-color, rgba(0, 0, 0, .2));box-shadow:var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow);}
.shadow-\\[0_8px_16px_rgba\\(0\\,0\\,0\\,\\.25\\)\\]{--un-shadow:0 8px 16px var(--un-shadow-color, rgba(0, 0, 0, .25));box-shadow:var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow);}
.hover\\:shadow-\\[0_12px_24px_rgba\\(0\\,0\\,0\\,\\.35\\)\\]:hover{--un-shadow:0 12px 24px var(--un-shadow-color, rgba(0, 0, 0, .35));box-shadow:var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow);}
.active\\:shadow-\\[0_4px_8px_rgba\\(0\\,0\\,0\\,\\.2\\)\\]:active{--un-shadow:0 4px 8px var(--un-shadow-color, rgba(0, 0, 0, .2));box-shadow:var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow);}
.outline-none{outline:2px solid transparent;outline-offset:2px;}
.transition-all{transition-property:all;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms;}
.transition-colors{transition-property:color,background-color,border-color,text-decoration-color,fill,stroke;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms;}
...
.ease-out{transition-timing-function:cubic-bezier(0, 0, 0.2, 1);};
  ...
  __decorateClass([
    r()
  ], ChromeTranslateSelection.prototype, "phase", 2);
  __decorateClass([
    r()
  ], ChromeTranslateSelection.prototype, "selectedText", 2);
  __decorateClass([
    r()
  ], ChromeTranslateSelection.prototype, "translatedText", 2);
  __decorateClass([
    r()
  ], ChromeTranslateSelection.prototype, "loading", 2);
  __decorateClass([
    r()
  ], ChromeTranslateSelection.prototype, "error", 2);
  __decorateClass([
    r()
  ], ChromeTranslateSelection.prototype, "posX", 2);
  __decorateClass([
    r()
